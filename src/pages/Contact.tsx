...
const contactData: ContactItem[] = [
  ...
  },
  {
    ...
    info: 'github.com/Qiufengluoyes',
    description: '访问我的GitHub主页',
    color: 'bg-gray-100 dark:bg-gray-700/30',
    isLink: true,
    link: 'https://github.com/Qiufengluoyes',
  },
  {
    id: 'bilibili',
    title: '哔哩哔哩',
    ...
    info: 'space.bilibili.com/1735270180',
    description: '关注我的哔哩哔哩空间',
    color: 'bg-[#00AEEC]/10 dark:bg-[#00AEEC]/20',
    isLink: true,
    link: 'https://space.bilibili.com/1735270180',
  },
];
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                我会尽量在 24 小时内回复消息。<span className="text-gray-800 dark:text-gray-300 font-medium">QQ和邮箱</span>是最快的联系方式，如有紧急事宜建议优先使用。若通过邮件联系，请注意检查垃圾邮件箱。
              </p>
            </div>
          </div>
        </motion.div>
